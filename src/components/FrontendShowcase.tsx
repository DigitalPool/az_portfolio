	...
	return (
		<section className="bg-black text-[#b7aa98] py-32 px-6">
			<div className="max-w-6xl mx-auto">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
					{frontendProjects.map((project, index) => (
						...
						>
							<img src={project.image} alt={project.title} className="w-full h-60 object-cover group-hover:scale-105 transition-transform" />
			...
			{selectedImage && (
				...
				>
					<img src={selectedImage} alt="Expanded View" className="max-w-4xl max-h-[90vh] object-contain border border-neutral-700 rounded-lg" />
